...
#define W_WHITE_LO                   7
#define W_WHITE_HI                    8
#define W_WARMWHITE_LO     9
#define W_WARMWHITE_HI      0
#define W_DOOR_SPD_LO       11
#define W_DOOR_SPD_HI          12
#define W_AUTOCLOSE_T_LO   13
#define W_AUTOCLOSE_T_HI    14
#define W_AUTOCLOSE              15
#define W_AUTOHOME_T_LO    16
#define W_AUTOHOME_T_HI     17
#define W_AUTOHOME               18
#define W_AUTOHOME_DIR       19
#define W_OT_LO                        20
#define W_OT_HI                         21
#define W_TOP_OR_LO         22
#define W_TOP_OR_HI         23
#define W_BOT_OR_LO         24
#define W_BOT_OR_HI         25
#define W_LIGHT_T_LO        26
#define W_LIGHT_T_HI        27
...
#define DEFAULT_WHITE                       0x7F
#define DEFAULT_WARMWHITE          0x7F
#define DEFAULT_DOOR_SPEED          0x7F
#define DEFAULT_DOOR_AUTOCLOSE_T    600  // 1 minute
#define DEFAULT_DOOR_AUTOCLOSE      1
#define DEFAULT_AUTOHOME_T          3000 // 5 minutes
#define DEFAULT_AUTOHOME            0
#define DEFAULT_AUTOHOME_DIR        0
#define DEFAULT_OVERTRAVEL_T        900
#define DEFAULT_TOP_OVERRUN         50 // should be about 15mm @60mm/s speed
#define DEFAULT_BOT_OVERRUN        50  // should be about 15mm @60mm/s speed
#define DEFAULT_LIGHTING_T          3000  // 5 minutes
...
extern uint32_t uart_warmwhite;
...
void Config_SetDefaults(void) {
    ...
    uart_warmwhite  = DEFAULT_WARMWHITE;
...
void Config_LoadAll(void) {
    ...
    uart_warmwhite  = READ32(W_WARMWHITE_LO);
...
void Config_SaveAll(void) {
    ...
    words[W_WARMWHITE_LO]        = (uint16_t)(uart_warmwhite                & 0xFFFF);
    words[W_WARMWHITE_HI]        = (uint16_t)(uart_warmwhite                >> 16);
