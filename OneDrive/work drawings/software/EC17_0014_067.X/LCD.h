...
////public: 
    ...
    */
   //virtual 
            size_t write(const uint8_t *buffer, size_t size) = 0;
    ...
    */
	//virtual 
    void load_custom_character(uint8_t char_num, uint8_t *rows) = 0;
    ...
    */   
	//virtual
    void setBacklight(uint8_t new_val) = 0;
    ...
    */
	//virtual
    void setContrast(uint8_t new_val) = 0;
